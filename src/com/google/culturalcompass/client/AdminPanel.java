...
public class AdminPanel extends VerticalPanel {
	...
	private void loadImportView() {
		...
		rootPanel.setWidgetLeftRight(hp2, 100, Unit.PX, 0, Unit.PX);
		rootPanel.setWidgetTopBottom(hp2, 780, Unit.PX, -700, Unit.PX);
	}
	...
	private void displayP(List<Place> places) {
		...
		rootPanel.setWidgetTopBottom(vp, 770, Unit.PX, -1500, Unit.PX);
		rootPanel.setWidgetLeftRight(vp2, 100, Unit.PX, 0, Unit.PX);
		rootPanel.setWidgetTopBottom(vp2, 780, Unit.PX, -1200, Unit.PX);
